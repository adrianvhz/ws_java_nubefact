...
public class NotaCredito {
	...
	private Integer tipo_de_nota_de_credito;
	...
	public Integer getTipo_de_nota_de_credito() {
		return tipo_de_nota_de_credito;
	}
	public void setTipo_de_nota_de_credito(Integer tipo_de_nota_de_credito) {
		this.tipo_de_nota_de_credito = tipo_de_nota_de_credito;
	}
	...
	public String toString() {
		return "NotaCredito [operacion=" + operacion + ", tipo_de_comprobante=" + tipo_de_comprobante + ", serie="
				...
				+ ", tipo_de_nota_de_credito=" + tipo_de_nota_de_credito + ", enviar_automaticamente_a_la_sunat="
				...
				+ items + ", medio_de_pago=" + medio_de_pago + "]";
	}
