...
public class Boleta {
	...
	public String toString() {
		return "Boleta [operacion=" + operacion + ", tipo_de_comprobante=" + tipo_de_comprobante + ", serie=" + serie
				...
				+ enviar_automaticamente_al_cliente + ", condiciones_de_pago=" + condiciones_de_pago + ", items="
				+ items + ", venta_al_credito=" + venta_al_credito + ", medio_de_pago=" + medio_de_pago + "]";
	}
