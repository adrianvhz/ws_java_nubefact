...
public class Factura {
	...
	private Integer cliente_tipo_de_documento;
	...
	public Integer getCliente_tipo_de_documento() {
		return cliente_tipo_de_documento;
	}
	public void setCliente_tipo_de_documento(Integer cliente_tipo_de_documento) {
	...
	public String toString() {
		return "Factura [operacion=" + operacion + ", tipo_de_comprobante=" + tipo_de_comprobante + ", serie=" + serie
				+ ", numero=" + numero + ", sunat_transaction=" + sunat_transaction + ", cliente_tipo_de_documento="
				+ cliente_tipo_de_documento + ", cliente_numero_de_documento=" + cliente_numero_de_documento
				+ ", cliente_denominacion=" + cliente_denominacion + ", cliente_direccion=" + cliente_direccion
				+ ", cliente_email=" + cliente_email + ", fecha_de_emision=" + fecha_de_emision
				+ ", fecha_de_vencimiento=" + fecha_de_vencimiento + ", moneda=" + moneda + ", tipo_de_cambio="
				+ tipo_de_cambio + ", porcentaje_de_igv=" + porcentaje_de_igv + ", total_descuento=" + total_descuento
				+ ", total_gravada=" + total_gravada + ", total_igv=" + total_igv + ", total=" + total
				+ ", observaciones=" + observaciones + ", enviar_automaticamente_a_la_sunat="
				+ enviar_automaticamente_a_la_sunat + ", enviar_automaticamente_al_cliente="
				+ enviar_automaticamente_al_cliente + ", condiciones_de_pago=" + condiciones_de_pago
				+ ", medio_de_pago=" + medio_de_pago + ", items=" + items + ", venta_al_credito=" + venta_al_credito
				+ "]";
	}
